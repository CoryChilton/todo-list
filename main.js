...
}`, "",{"version":3,"sources":["webpack://./src/style.css"],"names":[],"mappings":"AAAA;;;;;;;;;;;;;CAaC,SAAS;CACT,UAAU;CACV,SAAS;CACT,eAAe;CACf,aAAa;CACb,wBAAwB;AACzB;;AAEA;EACE,qBAAqB;AACvB;;AAEA;EACE,aAAa;EACb,YAAY;EACZ,aAAa;EACb,8BAA8B;AAChC;;AAEA;EACE,YAAY;EACZ,qBAAqB;AACvB;;AAEA;EACE,YAAY;EACZ,wBAAwB;AAC1B;;AAEA;EACE,WAAW;AACb;;AAEA;EACE,aAAa;AACf;;AAEA;EACE,2BAA2B;AAC7B;;AAEA;EACE,6BAA6B;AAC/B;;AAEA;EACE,0BAA0B;AAC5B","sourcesContent":["html, body, div, span, applet, object, iframe,\nh1, h2, h3, h4, h5, h6, p, blockquote, pre,\na, abbr, acronym, address, big, cite, code,\ndel, dfn, em, img, ins, kbd, q, s, samp,\nsmall, strike, strong, sub, sup, tt, var,\nb, u, i, center,\ndl, dt, dd, ol, ul, li,\nfieldset, form, label, legend,\ntable, caption, tbody, tfoot, thead, tr, th, td,\narticle, aside, canvas, details, embed, \nfigure, figcaption, footer, header, hgroup, \nmenu, nav, output, ruby, section, summary,\ntime, mark, audio, video {\n\tmargin: 0;\n\tpadding: 0;\n\tborder: 0;\n\tfont-size: 100%;\n\tfont: inherit;\n\tvertical-align: baseline;\n}\n\nul {\n  list-style-type: none;\n}\n\nbody {\n  height: 100vh;\n  width: 100vw;\n  display: grid;\n  grid-template-columns: 1fr 3fr;\n}\n\n#project-section {\n  height: 100%;\n  background-color: red; \n}\n\n#todo-section {\n  height: 100%;\n  background-color: purple;\n}\n\n.current-project {\n  color: blue;\n}\n\n#todo-section li {\n  display: flex;\n}\n\n.low-priority {\n  border-left: 3px solid blue;\n}\n\n.medium-priority {\n  border-left: 3px solid yellow;\n}\n\n.high-priority {\n  border-left: 3px solid red;\n}"],"sourceRoot":""}]);
// Exports
...
const domController = (function () {
  ...
  function clickConfirmTodoModalBtn(e) {
    if (todoForm.checkValidity()) {
      ...
      if (confirmTodoModalBtn.textContent === 'Add') {
        _logicController__WEBPACK_IMPORTED_MODULE_0__.logicController.addTodo(todoTitleInput.value, todoDescriptionTextArea.value, dueDate, todoPrioritySelect.value);
      } else {
        _logicController__WEBPACK_IMPORTED_MODULE_0__.logicController.editTodo(todoTitleInput.value, todoDescriptionTextArea.value, dueDate, todoPrioritySelect.value, e.target.dataset.index);
      }
      todoModal.close()
      render();
    }
  ...
  function clickConfirmProjectModalBtn() {
    if (projectForm.checkValidity()) {
      _logicController__WEBPACK_IMPORTED_MODULE_0__.logicController.addProject(newProjectNameInput.value);
      projectModal.close();
      render();
    }
  }
  ...
  function render(){
    ...
    const projects = _logicController__WEBPACK_IMPORTED_MODULE_0__.logicController.getProjects();
    const curProject = _logicController__WEBPACK_IMPORTED_MODULE_0__.logicController.getCurrentProject();
    const todos = _logicController__WEBPACK_IMPORTED_MODULE_0__.logicController.getTodos();
    todos.forEach((todo, idx) => {
      const todoLi = document.createElement('li');
      const todoContentDiv = document.createElement('div');
      todoContentDiv.textContent = `${todo.title} Due Date: ${todo.dueDate ? (0,date_fns__WEBPACK_IMPORTED_MODULE_1__["default"])(todo.dueDate, 'LLLL do, yyyy') : ''}`;
    ...
    function clickDeleteTodoBtn(e) {
      _logicController__WEBPACK_IMPORTED_MODULE_0__.logicController.deleteTodo(e.target.dataset.index);
      render();
    }
  ...
  function clickProject(e) {
    _logicController__WEBPACK_IMPORTED_MODULE_0__.logicController.setCurrentProject(e.target.dataset.index);
    render();
  }
...
const logicController = (function() {
  let curProject = (0,_project__WEBPACK_IMPORTED_MODULE_0__["default"])('General');
  ...
  function addProject(title) {
    const project = (0,_project__WEBPACK_IMPORTED_MODULE_0__["default"])(title);
